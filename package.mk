...
.PHONY: unpack_$(PHONY_TARGET_PREFIX)$(PACKAGE)
unpack_$(PACKAGE): $(SRC_DIR)/$(PACKAGE)/stamp.unpacked
.PHONY: prepare_$(PACKAGE)
prepare_$(PACKAGE): $(SRC_DIR)/$(PACKAGE)/stamp.prepared
.PHONY: configure_$(PHONY_TARGET_PREFIX)$(PACKAGE)
configure_$(PHONY_TARGET_PREFIX)$(PACKAGE): $(BUILD_DIR)/$(PACKAGE)/stamp.configured
.PHONY: build_$(PHONY_TARGET_PREFIX)$(PACKAGE)
build_$(PHONY_TARGET_PREFIX)$(PACKAGE): $(BUILD_DIR)/$(PACKAGE)/stamp.built
